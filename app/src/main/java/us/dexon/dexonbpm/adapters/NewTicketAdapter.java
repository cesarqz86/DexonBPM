...
/**
 * Created by Cesar Quiroz on 8/27/15.
 */
public class NewTicketAdapter extends ArrayAdapter<TicketDetailDataDto> {
    private final Context context;
    private final List<TicketDetailDataDto> values;
    private final TicketResponseDto ticketData;

    public NewTicketAdapter(Context context, List<TicketDetailDataDto> values, TicketResponseDto ticketInfo) {
